...
/** Classe che gestisce il panello delle liste di materie.
 * permette visualizzare la lista delle materie del corso e anno prescelti
  **/

public class Materie extends JPanel {
	...
	void listMaterie(){
		...
		this.add(new ListMaterieAdmin(anno, codiceCorso));
