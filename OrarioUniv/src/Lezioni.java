...
/** Classe che gestisce il panello dei diversi orari universitari.
 * permette di scegliere il corso di studio e l'anno
  **/


public class Lezioni extends JPanel {
	...
	void listLezioni(){
		...
		this.add(new ListLezioniAdmin(anno, codiceCorso));
